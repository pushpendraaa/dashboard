...
if selected == "Home":
  st.markdown("""<div style="line-height: 1.4; letter-spacing: 0.3px; font-weight: 500"> Monitoring the Water Quality in Bhopal Region using Satellite Imagery and GIS Techniques </div>""",
                unsafe_allow_html=True)
